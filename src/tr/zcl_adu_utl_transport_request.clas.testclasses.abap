...
CLASS ltcl_files DEFINITION FINAL
  ...
  PRIVATE SECTION.
    DATA mo_utility TYPE REF TO zcl_adu_utl_transport_request.
...
CLASS ltcl_files IMPLEMENTATION.
  ...
  METHOD build_path_cofiles.
    ...
    DATA(path) = mo_utility->zif_adu_utl_transport_request~build_path_cofiles( lc_transport_request ).
  ...
  METHOD build_path_data.
    ...
    DATA(path) = mo_utility->zif_adu_utl_transport_request~build_path_data( lc_transport_request ).
  ...
  METHOD build_tr_from_filename_cofile.
    ...
    DATA(lv_transport_request) = mo_utility->zif_adu_utl_transport_request~convert_filename_to_tr( lc_file_cofile ).
  ...
  METHOD build_tr_from_filename_data.
    ...
    DATA(lv_transport_request) = mo_utility->zif_adu_utl_transport_request~convert_filename_to_tr( lc_file_data ).
  ...
  METHOD build_tr_from_filename_error.
    ...
    TRY.
        DATA(lv_transport_request) =
            mo_utility->zif_adu_utl_transport_request~convert_filename_to_tr( lc_file_not_supported ).
  ...
  METHOD filename_valid.
    ...
    cl_abap_unit_assert=>assert_true( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `K9000000.A4H` ) ).
    cl_abap_unit_assert=>assert_true( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `R9000000.A4H` ) ).
  ...
  METHOD filename_invalid.
    ...
    cl_abap_unit_assert=>assert_false( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `X9000000.A4H` ) ).
    cl_abap_unit_assert=>assert_false( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `R90000000.A4H` ) ).
    cl_abap_unit_assert=>assert_false( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `SAP.A4H` ) ).

    cl_abap_unit_assert=>assert_false( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `A4HK90000000` ) ).
    cl_abap_unit_assert=>assert_false( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `A4HX9000000` ) ).
    cl_abap_unit_assert=>assert_false( mo_utility->zif_adu_utl_transport_request~is_filename_valid( `SAP.EXE` ) ).
