*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZADUVSWITCH_USER
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZADUVSWITCH_USER    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZADUVSWITCH_USER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZADUVSWITCH_USER_EXTRACT
TOTAL = ZADUVSWITCH_USER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZADUVSWITCH_USER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZADUVSWITCH_USER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADUVSWITCH_USER_EXTRACT
TOTAL = ZADUVSWITCH_USER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZADUVSWITCH_USER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZADUVSWITCH_USER'
...
TOTAL = ZADUVSWITCH_USER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZADUVSWITCH_USER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZADUVSWITCH_USER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZADUVSWITCH_USER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZADUVSWITCH_USER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADUVSWITCH_USER_EXTRACT
TOTAL = ZADUVSWITCH_USER_TOTAL
