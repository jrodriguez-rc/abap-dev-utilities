*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZADUVSWITCH
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZADUVSWITCH         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZADUVSWITCH'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZADUVSWITCH_EXTRACT
TOTAL = ZADUVSWITCH_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZADUVSWITCH'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZADUVSWITCH-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZADUVSWITCH_EXTRACT
TOTAL = ZADUVSWITCH_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZADUVSWITCH-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZADUVSWITCH'
...
TOTAL = ZADUVSWITCH_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZADUVSWITCH-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZADUVSWITCH-UPD_FLAG NE SPACE.
